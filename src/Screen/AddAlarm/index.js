...
const AddAlarm = () => {
  ...
  const toggleVibrateSwitch = () => setIsVibrateEnabled(previousState => !previousState);
  const toggleSnoozeSwitch = () => setIsSnoozeEnabled(previousState => !previousState);
  ...
  const renderButtons = () => {
    return (
      <View style={{
        ...
        <TouchableOpacity onPress={toggleRingOnce} style={{
          ...
          <Text style={{ color: ringOnce ? colors.drawerBlack : colors.white }}>Ring Once</Text>
        </TouchableOpacity>
        ...
        <TouchableOpacity onPress={toggleRingOnce} style={{
          ...
          <Text style={{ color: custom ? colors.drawerBlack : colors.white }}>Custom</Text>
        </TouchableOpacity>
      </View>
    )
  }
  ...
  const renderRepat = () => {
    return (
      <TouchableOpacity onPress={setRepeatPicker} style={{
        justifyContent: 'center',
        width: 85 * vw,
      }}>
        <Text style={{
        ...
        }}> {selectedRepeatValue ? selectedRepeatValue : 'Select'}</Text>
      </TouchableOpacity>
    )
  }
